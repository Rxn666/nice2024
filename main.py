...
candidate_fn = f'datasets/nice/eval_res/w{weight_index}/vis_id_top{topk}_mask{mask_num}-10.csv'
...
parser.add_argument('--mode', type=str, help='whether go through all procedure.')
